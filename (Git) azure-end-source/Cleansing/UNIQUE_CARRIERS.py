...
PLANE_path = "/mnt/raw_datalake/UNIQUE_CARRIERS/"
df = spark.read.format("parquet").load(PLANE_path)
...
df_base.write.format("delta").mode("overwrite").save("/mnt/cleansed_datalake/UNIQUE_CARRIERS")

# COMMAND ----------

df_Plane_read=spark.read.format("delta").load("/mnt/cleansed_datalake/UNIQUE_CARRIERS")

# COMMAND ----------

# MAGIC %sql
# MAGIC    select * from cleansed_EndtoEnd.UNIQUE_CARRIERS
